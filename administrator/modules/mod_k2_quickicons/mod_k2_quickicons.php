<?php
/**
 * @version		$Id: mod_k2_quickicons.php 1731 2012-10-10 23:02:03Z joomlaworks $
 * @package		K2
...
if($modCSSStyling) $document->addStyleSheet(JURI::base(true).'/modules/'.$mod_name.'/tmpl/css/style.css?v=2.6.1');
